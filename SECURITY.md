...
1. Envie descrição detalhada para o mantenedor via GitHub Security Advisories ou contato privado do repositório [local-rag-second-mind-vault](https://github.com/SrSatriano/local-rag-second-mind-vault).
