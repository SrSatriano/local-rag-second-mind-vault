...
Obrigado por considerar uma contribuição para **Cofre RAG local "Second Mind"**.

## Como começar

1. Faça um fork do repositório [local-rag-second-mind-vault](https://github.com/SrSatriano/local-rag-second-mind-vault).
